...
extension MeasurementTest {
  func testInit_FloatLiteral() {
    ...
    XCTAssertEqual(123.0, Measurement<UnitConcentrationMass>(value: 123, unit: UnitConcentrationMass.default))
    ...
    XCTAssertEqual(123.0, Measurement<UnitElectricCharge>(value: 123, unit: UnitElectricCharge.default))
    XCTAssertEqual(123.0, Measurement<UnitElectricCurrent>(value: 123, unit: UnitElectricCurrent.default))
    XCTAssertEqual(123.0, Measurement<UnitElectricPotentialDifference>(value: 123, unit: UnitElectricPotentialDifference.default))
    XCTAssertEqual(123.0, Measurement<UnitElectricResistance>(value: 123, unit: UnitElectricResistance.default))
    ...
    XCTAssertEqual(123.0, Measurement<UnitFuelEfficiency>(value: 123, unit: UnitFuelEfficiency.default))
    XCTAssertEqual(123.0, Measurement<UnitIlluminance>(value: 123, unit: UnitIlluminance.default))
    XCTAssertEqual(123.0, Measurement<UnitInformationStorage>(value: 123, unit: UnitInformationStorage.default))

...
extension MeasurementTest {
  func testInit_IntegerLiteral() {
    ...
    XCTAssertEqual(123, Measurement<UnitConcentrationMass>(value: 123, unit: UnitConcentrationMass.default))
    ...
    XCTAssertEqual(123, Measurement<UnitElectricCharge>(value: 123, unit: UnitElectricCharge.default))
    XCTAssertEqual(123, Measurement<UnitElectricCurrent>(value: 123, unit: UnitElectricCurrent.default))
    XCTAssertEqual(123, Measurement<UnitElectricPotentialDifference>(value: 123, unit: UnitElectricPotentialDifference.default))
    XCTAssertEqual(123, Measurement<UnitElectricResistance>(value: 123, unit: UnitElectricResistance.default))
    ...
    XCTAssertEqual(123, Measurement<UnitFuelEfficiency>(value: 123, unit: UnitFuelEfficiency.default))
    XCTAssertEqual(123, Measurement<UnitIlluminance>(value: 123, unit: UnitIlluminance.default))
    XCTAssertEqual(123, Measurement<UnitInformationStorage>(value: 123, unit: UnitInformationStorage.default))
